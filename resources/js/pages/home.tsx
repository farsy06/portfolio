                        ...
                        <div className="flex items-center space-x-2">
                            ...
                            <div className="flex items-center">
                                <motion.button
                                    ...
                                    className="relative p-2 rounded-full hover:bg-gray-200 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 dark:focus:ring-offset-gray-800 transition-colors duration-300"
                                ...
                                >
                                    <span className="relative z-10 block" data-cursor-hover>
                                        {isDark ? (
